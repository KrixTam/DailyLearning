...
class OpenAIModel:
    ...
    def __post_init__(self):
        ...
        self.client = AsyncOpenAI(api_key=your_api_key, base_url=self.base_url, timeout=600)
    ...
    # )
    async def generate(self, text: str, history: Optional[List[str]] = None, temperature: float = 0) -> str:
