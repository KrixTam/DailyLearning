...
class PolicyAnalyzer:
    ...
    def analyze(self, pdf_filename, interval: int = 10, artifacts_path_local: str = None):
        loop = create_event_loop()
        loop.run_until_complete(async_analyze(self, self.max_concurrent, pdf_filename, interval, artifacts_path_local))
...
if __name__ == '__main__':
    ...
    policy_analyzer.analyze(pdf_filename, 3, artifacts_path_local)
